...
import kotlin.com.mbz.Terrian;
import kotlin.com.mbz.concurrent.ThreadPools;
import kotlin.com.mbz.config.PerformanceConfig;
import kotlin.com.mbz.data.worldgen.preset.settings.Preset;
import kotlin.com.mbz.registries.RTFRegistries;
import kotlin.com.mbz.tags.RTFDensityFunctionTags;
import kotlin.com.mbz.world.worldgen.GeneratorContext;
import kotlin.com.mbz.world.worldgen.RTFRandomState;
import kotlin.com.mbz.world.worldgen.densityfunction.CellSampler;
import kotlin.com.mbz.world.worldgen.densityfunction.NoiseFunction;
import kotlin.com.mbz.world.worldgen.noise.module.Noise;
import kotlin.com.mbz.world.worldgen.noise.module.Noises;
import kotlin.com.mbz.world.worldgen.terrablender.TBClimateSampler;
import kotlin.com.mbz.world.worldgen.terrablender.TBCompat;
...
class MixinRandomState {
	...
	public void mbz$MBZRandomState$initialize(RegistryAccess registries) {
...
//				throw new IllegalStateException("Missing preset!");
	...
	@Nullable
	public Preset mbz$MBZRandomState$preset() {
		return this.preset;
	}
	
	@Nullable
	public GeneratorContext mbz$MBZRandomState$generatorContext() {
		return this.generatorContext;
	}

	@Nullable
	public DensityFunction mbz$MBZRandomState$wrap(DensityFunction function) {
		return function.mapAll(this.densityFunctionWrapper);
	}

	public Noise mbz$MBZRandomState$seed(Noise noise) {
