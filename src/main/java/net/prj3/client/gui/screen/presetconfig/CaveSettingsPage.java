package net.prj3.client.gui.screen.presetconfig;

import java.util.Optional;

import net.minecraft.client.gui.components.CycleButton;
import net.minecraft.network.chat.Component;
import net.prj3.client.data.RTFTranslationKeys;
import net.prj3.client.gui.screen.page.LinkedPageScreen.Page;
import net.prj3.client.gui.screen.presetconfig.PresetListPage.PresetEntry;
import net.prj3.client.gui.widget.Slider;
import net.prj3.data.worldgen.preset.settings.CaveSettings;
