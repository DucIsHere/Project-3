package net.prj3.world.worldgen.cell.climate;
...
import net.prj3.world.worldgen.noise.module.LegacyMoisture;
import net.prj3.world.worldgen.noise.module.LegacyTemperature;
